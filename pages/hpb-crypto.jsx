...
const HPBCryptoPage = () => {
  ...
  return (
    <>
      <Head>
        <title>HPB Crypto | ESportsRef</title>
      </Head>
      <div className="px-8 mx-8">
        <h2 className="flex justify-center pt-8 mt-8 text-5xl yellow-title">HPB CRYPTO</h2>
        <p className="px-8 py-6 mx-8">
        ...
        <div className="flex justify-center"><img src="/images/hpb-blockchain-image.png" alt=""/></div>
        <p className="px-8 py-2 mx-8">
        ...
        <div className="flex justify-center"><img src="/images/smart-contracts.png" alt=""/></div>
        <p className="px-8 py-2 mx-8">
        ...
        <div className="flex justify-center"><img src="/images/Dapps-300x169.png" alt=""/></div>
        <p className="px-8 py-2 mx-8">
        ...
        <h1 className="px-8 mx-8 text-2xl yellow-title">SPEED</h1>
        <p className="px-8 py-6 mx-8">
        ...
        <h1 className="px-8 mx-8 text-2xl yellow-title">LOWER GAS FEES</h1>
        <p className="px-8 py-6 mx-8">
        ...
        <h1 className="px-8 mx-8 text-2xl yellow-title">RANDOM NUMBERS</h1>
        <p className="px-8 py-6 mx-8">
        ...
        <h1 className="px-8 mx-8 text-2xl yellow-title">SO HOW DO I GET SOME HPB?</h1>
        <p className="px-8 pt-6 mx-8">
        ...
        <div className="flex justify-center my-6"><img src="/images/kucoin-500x300.png" alt=""/></div>
        <p className="px-8 py-2 mx-8">
        ...
        <div className="flex justify-center my-6"><img src="/images/kucoin-get-HPB-1200x800.png" className="w-5/6" alt=""/></div>
        <p className="px-8 py-5 mx-8">
        ...
        <div className="flex justify-center my-6"><img src="/images/kucoin-main-trade-page.png" className="w-5/6" alt=""/></div>
        <p className="px-8 py-5 mx-8">
        ...
        <div className="flex justify-center my-6"><img src="/images/kucoin-price-chart.png" alt=""/></div>
        <p className="px-8 py-2 mx-8">
        ...
        <div className="flex justify-center my-6"><img src="/images/order-book.png" alt=""/></div>
        <p className="px-8 py-2 mx-8">
        ...
        <div className="flex justify-center my-6"><img src="/images/purchasing-your-HPB.png" alt=""/></div>
        <p className="px-8 py-2 mx-8">
